...
var starter_decks := [
	...
	#WIND
	[CardDB.PATH["DRAKE_OF_EMERALD"], CardDB.PATH["FALCREEP"], CardDB.PATH["BOOGLES"], CardDB.PATH["WIND_ARMOR"], CardDB.PATH["YORG_ARCHER"]],
	#WATER
	[CardDB.PATH["FYSH"], CardDB.PATH["AQUA_WHIP"], CardDB.PATH["TIDAL_WAVE"], CardDB.PATH["FINN"], CardDB.PATH["ICE_CRAB"]],
]
