extends Node3D
class_name Board3DTutorial

@export var tile_scene: PackedScene
@export var width: int = 7
@export var height: int = 7
@export var spacing: float = 1.1
@onready var card_ui: ArenaCardDetails = get_node("../UISystemTutorial/ArenaCardDetails")
@onready var terrain_ui: Control = get_node("../UISystemTutorial/ArenaTerrainDetails")
@onready var core: ArenaCoreTutorial = $".."
