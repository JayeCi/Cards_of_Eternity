...
extends Node
class_name ArenaBattleTutorial

#const CARD_MODEL_SCALE := Vector3(0.25, 0.25, 0.25)

var core: ArenaCoreTutorial
var board: Node3D
var ui: ArenaUITutorial
var cam: ArenaCameraTutorial
...
func init_battle(core_ref: ArenaCoreTutorial) -> void:
	core = core_ref
	board = core.board
	ui = core.get_node("UISystemTutorial")
...
func _play_2d_battle(att: UnitData, defn: UnitData) -> Dictionary:
	...
	var battle_ui: BattleUI = core.get_node_or_null("UISystemTutorial/BattleUI")
	if not battle_ui:
